                    ...
                    in    standard_metadata_t standard_metadata)
{
    ...
    apply{
        ...
        debug_ingress_std_meta.apply(standard_metadata);
        ...
        if (hdr.int_meta.remaining_hop_cnt == 0) {
            ...
            */
            ...
            if (hdr.ipv4.totalLen + meta.int_metadata.insert_byte_cnt
                ...
                // Add INT metadata and update INT shim header and outer header.
                int_hop_cnt_decrement();
                debug_std_meta.apply(standard_metadata);
                        ...
                        in    standard_metadata_t standard_metadata)
{
        ...
        bit<4> ins_mask0003, bit<4> ins_mask0407, bit<4> ins_mask1215)
    {
        ...
        field and skip over INT header.*/
...
control Telemetry_Ingress(inout headers_t hdr,
                   inout metadata meta,
                   in    standard_metadata_t standard_metadata)
{
...
control Telemetry_Egress(inout headers_t hdr,
                   inout metadata meta,
                   in    standard_metadata_t standard_metadata)
{
